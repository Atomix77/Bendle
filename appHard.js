...
guessCount = localStorage.getItem("bendleHard_guessCount");
characterSelect = localStorage.getItem("bendleHard_Character");
...
const characterDictionary = {
  ...
  pictureTitle: "<img src='characterPictures/GyatsoPicture'> </img>",
  ...
  pictureTitle: "<img src='characterPictures/PiandoPicture.webp'> </img>",
  ...
  addInfoTitle: "Leader of the Freedom Fighters",
  pictureTitle: "<img src='characterPictures/SmellerbeePicture'> </img>",
    ...
    switch (count) {
      case 0:
        if (currentID.text != currentCharacter) {
          ...
          localStorage.setItem("bendleHard_guess1", guess.textContent);
      ...
      case 1:
        if (currentID.text != currentCharacter) {
          ...
          localStorage.setItem("bendleHard_guess2",guess.textContent);
      ...
      case 2:
        if (currentID.text != currentCharacter) {
          ...
          localStorage.setItem("bendleHard_guess3",guess.textContent);
      ...
      case 3:
        if (currentID.text != currentCharacter) {
          ...
          localStorage.setItem("bendleHard_guess4",guess.textContent);
      ...
      case 4:
        if (currentID.text != currentCharacter) {
          ...
          localStorage.setItem("bendleHard_guess5",guess.textContent);
      ...
      case 5:
        if (currentID.text != currentCharacter) {
          ...
          localStorage.setItem("bendleHard_guess6",guess.textContent);
      ...
      case 6:
        if (currentID.text != currentCharacter) {
          ...
          localStorage.setItem("bendleHard_guess7",guess.textContent);
      ...
      case 7:
        if (currentID.text != currentCharacter) {
          ...
          localStorage.setItem("bendleHard_guess8",guess.textContent);
