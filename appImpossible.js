    ...
    switch (count) {
      case 0:
        if (currentID.text != currentCharacter) {
          ...
          localStorage.setItem("bendleImpossible_guess1", guess.textContent);
      ...
      case 1:
        if (currentID.text != currentCharacter) {
          ...
          localStorage.setItem("bendleImpossible_guess2",guess.textContent);
      ...
      case 2:
        if (currentID.text != currentCharacter) {
          ...
          localStorage.setItem("bendleImpossible_guess3",guess.textContent);
      ...
      case 3:
        if (currentID.text != currentCharacter) {
          ...
          localStorage.setItem("bendleImpossible_guess4",guess.textContent);
      ...
      case 4:
        if (currentID.text != currentCharacter) {
          ...
          localStorage.setItem("bendleImpossible_guess5",guess.textContent);
      ...
      case 5:
        if (currentID.text != currentCharacter) {
          ...
          localStorage.setItem("bendleImpossible_guess6",guess.textContent);
      ...
      case 6:
        if (currentID.text != currentCharacter) {
          ...
          localStorage.setItem("bendleImpossible_guess7",guess.textContent);
      ...
      case 7:
        if (currentID.text != currentCharacter) {
          ...
          localStorage.setItem("bendleImpossible_guess8",guess.textContent);
